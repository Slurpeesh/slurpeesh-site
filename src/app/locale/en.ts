export enum En {
  ...
  'tools' = 'Tools',
  'descriptionSkillInsight' = 'Skill Insight is a desktop cross-platform application for collecting statistics on skills depending on the selected areas and the entered search query. This application is useful for tracking the relevance of skills in the labor market, for those who want to become a specialist, but do not know what to study, as well as for educational institutions to improve the quality of training. The application uses the HeadHunter API, supports a dark theme, and is multilingual.',
