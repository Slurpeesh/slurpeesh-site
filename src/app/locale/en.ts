export enum En {
  ...
  'tools' = 'Tools',
  'descriptionSkillInsightSite' = 'This site provides a convenient way to download the right version of Skill Insight application depending on the operating system using GitHub API, and describes the features of this application. It has good SEO optimization thanks to Next.JS, dark theme and multi-language support.',
  'descriptionGuessWhoWar3' = 'This is a browser game for multiple players, which consists of guessing a unit from the game Warcraft 3 by its phrase. Creation and connection to the lobby by ID, volume control, dark theme and chat within the lobby are implemented. It is also mobile adaptive.',
  'descriptionAnonChat' = 'AnonChat is a real-time chat, which is designed for anonymous correspondence between 2 people, it is a fullstack application with a client and server part that exchange messages via the WebSocket protocol. There is a notification system and a dark theme.',
  ...
  'descriptionInteractiveCard' = 'Frontend Mentor training project where a form and an interactive credit card had to be created. A check of user input data was implemented, a message when the check was successful, and a responsive design for mobile devices was implemented.',
  ...
  'tooltipNextJS' = 'I got acquainted with this framework in 2024, I actively study it and try to use all its features to develop web applications.',
  ...
  'tooltipVite' = 'I got acquainted with Vite after Webpack, it was Vite that was used in the development of this site.',
  ...
  'tooltipSocketIO' = 'With the help of this library I developed an anonymous chat room and a browser game - real-time applications that use WebSocket protocol on the backend.',
