export enum En {
  ...
  'tools' = 'Tools',
  'descriptionGuessWhoWar3' = 'This is a browser game for multiple players, which consists of guessing a unit from the game Warcraft 3 by its phrase. Creation and connection to the lobby by ID, volume control, and chat within the lobby are implemented.',
