...
const NashEquilibriumArticle = motion(
  forwardRef(function NashEquilibriumArticle(_, ref: LegacyRef<HTMLElement>) {
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 flex justify-center items-center text-center font-medium mb-2 lg:mb-0 text-2xl sm:text-4xl lg:text-5xl xl:text-6xl">
          <a
            href="https://slurpeesh.github.io/Nash-equilibrium/"
            target="_blank"
...
export default NashEquilibriumArticle
