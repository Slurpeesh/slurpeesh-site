...
import img1 from '@/features/DMUUArticle/assets/1.png'
import img2 from '@/features/DMUUArticle/assets/2.png'
import img3 from '@/features/DMUUArticle/assets/3.png'
import img4 from '@/features/DMUUArticle/assets/4.png'
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex justify-center items-center text-center font-medium mb-2 lg:mb-0 text-2xl sm:text-4xl lg:text-5xl xl:text-6xl">
        <a
          href="https://slurpeesh.github.io/DMUU/"
          target="_blank"
      ...
      <div className="relative z-10 row-span-2 h-[100px] lg:h-full w-full">
        <Gallery imageSrcs={[img1, img2, img3, img4]} portalId={'1'} />
      </div>
