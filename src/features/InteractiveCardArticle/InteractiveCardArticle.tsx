...
const InteractiveCardArticle = motion(
  forwardRef(function InteractiveCardArticle(_, ref: LegacyRef<HTMLElement>) {
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 row-span-2 h-[100px] lg:h-full w-full">
          <Gallery imageSrcs={[img1, img2, img3, img4, img5]} portalId={'3'} />
        </div>
...
export default InteractiveCardArticle
